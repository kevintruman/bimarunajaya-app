...
@Slf4j
public class EditPackageView extends ContainerLayout {

    private Integer id;

    public EditPackageView(Integer id) {
        super();
        setMargin(false);
        setPadding(false);
        setSpacing(false);
    ...
    private void initData() {
        ...
        txBerat.setValue(String.format("%.0f", packageData.getWeight()));
