...
@Slf4j
public class PackageDataCashierView extends ContainerLayout {

    public PackageDataCashierView() {
        super();
        init();
    }
    ...
    private void initData() {
        ...
        grid.asSingleSelect().addValueChangeListener(e -> {
            ...
            if (e.getValue() != null) {
                ...
                if (e.getValue().getLastStation() != null &&
                        e.getValue().getLastStation().getId().equals(getUser().getStation().getId()) &&
                        e.getValue().getLastDeliveryStatus().getId().equals(TypeService.statusTransit)) {
...
//            String s = ServletUriComponentsBuilder.fromCurrentContextPath().toUriString();
    ...
    private void setItemsPackages() {
        ...
        List<PackageEntity> r = packageService.getForCashier(getUser().getStation(), txSearch.getValue());
        grid.setItems(r);
    }
